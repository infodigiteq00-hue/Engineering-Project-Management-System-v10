...
DROP POLICY IF EXISTS "Users can update assigned standalone equipment" ON public.standalone_equipment;
...
-- Policy 9: Users can update standalone equipment they're assigned to (via team_positions)
